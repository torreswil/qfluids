...
class Rest_mvc extends CI_Controller {
	...
	public function load_settings_materials(){
		$all_materials = $this->Api->get_where('vista_materiales',array('project'=>$this->project_id,'active'=>1),array('commercial_name','asc'));
