<div class="options_panel" id="outgoing_materials_overlay" style="display:none; background-image: none; left: 100px; right: 100px; bottom: 80px; z-index: 998">	
        <div style="margin: 20px">		
                <h5 style="color: #384939; font-family: 'OpenSansSemibold',Arial,sans-serif; font-size: 18px; font-weight: normal; margin: 0 0 20px;">Stock Transfers - Outgoing</h5>		
        </div>
