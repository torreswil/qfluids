...
--
-- Servidor: localhost
-- Tiempo de generación: 12-10-2012 a las 21:46:08
...
CREATE TABLE IF NOT EXISTS `project_report_centrifugues` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_project_report_centrifugues_project_centrifugues_idx` (`project_centrifugues_id`),
  KEY `fk_project_report_centrifugues_reports_idx` (`report_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `project_report_mudcleaner` (
  ...
  `operational_hours` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_project_report_mudcleaner_project_mudcleaner_idx` (`project_mudcleaner_id`),
  KEY `fk_project_report_mudcleaner_reports_idx` (`report_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `project_report_shakers` (
  ...
  `screens5` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_project_report_shakers_reports_idx` (`report_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
(2, '002', '2012-10-08', 'CAMBRIA 1', 'ORITO (PETROMINERALES)', 1, 'incoming'),
(3, '003', '2012-10-10', 'TEST', 'ORITO (PETROMINERALES)', 1, 'incoming'),
(4, '004', '2012-10-10', 'TEST', 'ORITO (PETROMINERALES)', 1, 'incoming');
