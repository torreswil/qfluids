...
--
-- Servidor: localhost
-- Tiempo de generación: 02-10-2012 a las 18:46:22
...
(21, 'r5435', 'ljlkj', 'kljklj', 1, 1, 500, 1);
...
CREATE TABLE IF NOT EXISTS `program` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_program_test_idx` (`test_id`),
  KEY `fk_program_projects_idx` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
(1, 'FCKGW', '2012-09-05 10:06:37', 'ORITO', 'PETROMINERALES', 'CAMBRIA1', 'ORITO', '0000', 'ORITO', 1, NULL, '2012-09-05 10:06:37', '2012-09-05', 0, 3, 3, 1, 3, 1, 0);
...
CREATE TABLE IF NOT EXISTS `project_report_test` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_project_report_test_program_idx` (`program_id`),
  KEY `fk_project_report_test_reports_idx` (`report_id`),
  KEY `fk_project_report_test_test_idx` (`test_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
(1, 1, 1, 2, 30, 20, 15, NULL, NULL, NULL, NULL, 1, 0, 0.9, 30, 1, 1),
(2, 1, 1, 12, 30, 20, 10, NULL, NULL, NULL, NULL, 1, 0, 0.6, 30, 1, 1),
(3, 1, 1, 15, 30, 20, 10, NULL, NULL, NULL, NULL, 1, 0, 0.6, 30, 1, 1),
(4, 1, 1, 16, 30, 20, 10, NULL, NULL, NULL, NULL, 0, 0, 0.6, 30, 2, 1),
(5, 1, 1, 13, 30, 20, 10, NULL, NULL, NULL, NULL, 2, 0, 0.6, 30, 2, 1),
(6, 1, 4, 14, NULL, NULL, 500, NULL, NULL, NULL, 200, 2, 0, 1619, 200, 3, 1);
...
--
ALTER TABLE `program`
  ADD CONSTRAINT `fk_program_test` FOREIGN KEY (`test_id`) REFERENCES `test` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_program_projects` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `project_report_test`
--
ALTER TABLE `project_report_test`
  ADD CONSTRAINT `fk_project_report_test_program` FOREIGN KEY (`program_id`) REFERENCES `program` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_project_report_test_reports` FOREIGN KEY (`report_id`) REFERENCES `reports` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_project_report_test_test` FOREIGN KEY (`test_id`) REFERENCES `test` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
